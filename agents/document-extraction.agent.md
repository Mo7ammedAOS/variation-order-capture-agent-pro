...
Read PDFs, screenshots, scanned documents and drawings. Extract drawing numbers, document revisions, RFI numbers, contract references and project references.
...
`/agents/prompts/document-extraction.prompt.md` — not yet written.

...
Draft the scope description of a Variation Proposal from the captured evidence, for human review.
...
`/agents/prompts/vo-description-drafting.prompt.md` — not yet written.

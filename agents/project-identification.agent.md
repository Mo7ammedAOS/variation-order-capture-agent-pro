...
Suggest which project a capture belongs to, from sender, content, drawing number and contract reference. Never guesses.
...
`/agents/prompts/project-identification.prompt.md` — not yet written.

...
Draft a Notice of Potential Claim from the captured evidence and the project contract rules, for human review.
...
`/agents/prompts/notice-drafting.prompt.md` — not yet written.

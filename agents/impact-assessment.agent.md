...
Suggest whether a change carries possible cost impact, possible time impact, and which trades are affected. Suggestion only, never a value.
...
`/agents/prompts/impact-assessment.prompt.md` — not yet written.

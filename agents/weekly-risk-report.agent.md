...
Prepare the narrative sections of the weekly commercial risk report from data the application has already calculated.
...
`/agents/prompts/weekly-risk-report.prompt.md` — not yet written.

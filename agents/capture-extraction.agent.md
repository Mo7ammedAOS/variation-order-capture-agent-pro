...
Read a captured message and extract a structured Potential Change: what changed, where, who requested it, affected trade, whether work has started.
...
`/agents/prompts/capture-extraction.prompt.md` — not yet written.

...
Summarise current bottlenecks into readable narrative for a PM, CM or Director. Reads computed data, never computes it.
...
`/agents/prompts/bottleneck-summary.prompt.md` — not yet written.
